...
@section('title', 'Pengaturan Bidan - MomSpire')
@section('header_title', 'Pengaturan')
@section('header_subtitle', 'Kelola profil akun bidan, email, dan keamanan password.')
    ...
    <div class="row g-4 mb-4 align-items-start">
        ...
        <div class="col-lg-8">
            <div class="admin-card settings-section h-100">
                ...
                <div class="card-body">
                    <form id="bidanProfileForm" action="{{ route('bidan.settings.profile') }}" method="POST">
                        @csrf
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label class="form-label">Nama Lengkap</label>
                                <input type="text" class="form-control" id="bidanProfileNama" name="name" value="{{ old('name', $bidanUser->name) }}" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Email</label>
                                <input type="email" class="form-control" id="bidanProfileEmail" name="email" value="{{ old('email', $bidanUser->email) }}" required>
                            </div>
                            <div class="col-12">
                                <label class="form-label">No. Telepon</label>
                                <input type="tel" class="form-control" id="bidanProfileTelp" name="no_telp" value="{{ old('no_telp', $bidanUser->no_telp ?? '') }}" placeholder="08xxxxxxxxxx">
                            </div>
                        </div>
                        <div class="mt-4">
    ...
    <div class="row g-4 mb-4 align-items-start">
        ...
        <div class="col-lg-8">
            <div class="admin-card settings-section h-100">
                ...
                <div class="card-body">
                    <form id="bidanPasswordForm" action="{{ route('bidan.settings.password') }}" method="POST">
                        @csrf
                        <div class="mb-3">
        ...
        if (resetTwoFactorSetupBtn) {
            resetTwoFactorSetupBtn.addEventListener('click', function() {
                requirePasswordConfirmation({
                    ...
                    text: 'Masukkan password bidan. Secret pending akan diganti, jadi scan ulang QR baru di authenticator.',
