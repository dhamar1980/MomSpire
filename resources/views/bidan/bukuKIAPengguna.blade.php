...
@section('header_action')
	<a href="{{ route('bidan.pengguna') }}" class="btn btn-back-page">
        ...
        <div class="bp-card-body">
                    ...
                    @foreach($entries as $entry)
                        <div class="bp-entry-item">
                            ...
                            <div class="bp-entry-actions">
                                ...
                                <form action="{{ route('bidan.pengguna.bukuKIA.destroy', $entry->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin hapus catatan ini?')">
                                    @csrf
                                    @method('DELETE')
            ...
            <div id="tab-tambah-buku" class="bp-tab-content">
                ...
                <div class="bp-form-card">
                    ...
                    <form method="POST" action="{{ route('bidan.pengguna.bukuKIA.store', $pengguna->id) }}">
                        @csrf
