...
@section('title', 'Jadwal Bidan - MomSpire')
    ...
    <div class="section-card p-4 p-lg-5 mb-4">
        <div class="row align-items-center g-3">
            ...
            <div class="col-lg-4 text-lg-end">
                <form method="GET" action="{{ route('bidan.jadwal') }}" class="d-flex gap-2">
    ...
    <div class="row g-4">
        <div class="col-lg-5">
            <div class="section-card p-4 h-100">
                ...
                <form method="POST" action="{{ route('bidan.jadwal.store') }}" id="jadwalForm">
                    @csrf
