...
@section('header_subtitle', 'Lihat dan kelola data pengguna yang sedang ditangani.')
    ...
    <div class="card role-card hero-role detail-hero mb-4">
        <div class="card-body p-4 p-lg-5">
            <div class="detail-topbar">
                ...
                <form method="GET" action="{{ route('bidan.pengguna') }}" class="detail-search d-flex gap-2 flex-grow-1 justify-content-lg-end">
...
<div class="modal fade" id="tambahJadwalModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('bidan.jadwal.store') }}">
                @csrf
