...
return new class extends Migration
{
    ...
    {
        Schema::create('kia_pemantauan_bulanan_bayis', function (Blueprint $table) {
            $table->id();
            $table->foreignId('data_kia_id')->constrained('data_kias')->onDelete('cascade');
            $table->integer('bulan_ke'); // Bulan ke-3, 4, 5
    ...
    {
        Schema::dropIfExists('kia_pemantauan_bulanan_bayis');
    }
};
