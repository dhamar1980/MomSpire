...
return new class extends Migration
{
    ...
    {
        Schema::create('kia_pemantauan_bulanan_anak_72s', function (Blueprint $table) {
            $table->id();
            $table->foreignId('data_kia_id')->constrained('data_kias')->onDelete('cascade');
            $table->integer('bulan_ke'); // 24 sampai 71
    ...
    {
        Schema::dropIfExists('kia_pemantauan_bulanan_anak_72s');
    }
};
