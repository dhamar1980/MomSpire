<?php $__env->startSection('title', 'Kelas Ibu Hamil - MomSpire'); ?>
<?php $__env->startSection('header_title', 'Kelas Ibu Hamil'); ?>
<?php $__env->startSection('header_subtitle', 'Catat absensi kehadiran Kelas Ibu Hamil secara mandiri.'); ?>
                    ...
                    <table class="table table-bordered table-hover align-middle small mb-0 text-center">
                        ...
                        <tbody>
                            <?php $__currentLoopData = range(1, 9); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php $item = $absen->get($i); ?>
                                <form action="<?php echo e(route('pengguna.kelas_ibu.save')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="kehadiran_ke" value="<?php echo e($i); ?>">
                                    <tr>
                                        <td class="fw-bold bg-light fs-5 text-secondary"><?php echo e($i); ?></td>
                                        <td>
                                            <input type="text" name="tanggal" value="<?php echo e($item->tanggal ?? ''); ?>" placeholder="Contoh: 15 Mei 2026" class="form-control rounded-pill text-center border-2 px-3">
                                        </td>
                                        <td>
                                            <input type="text" name="kader_info" value="<?php echo e($item->kader_info ?? ''); ?>" placeholder="Contoh: 15/05/26 - Kader Susi (Paraf)" class="form-control rounded-pill border-2 px-3">
                                        </td>
                                        <td>
                            ...
                            <div class="col-12">
                                <div class="card border-0 bg-light rounded-4 p-3 shadow-xs">
                                    <div class="d-flex align-items-center justify-content-between mb-3 border-bottom pb-2">
                                        <span class="badge bg-primary rounded-pill px-3 py-2 fw-bold fs-6">Kehadiran <?php echo e($i); ?></span>
                                        <?php if($item): ?>
                                    ...
                                    <form action="<?php echo e(route('pengguna.kelas_ibu.save')); ?>" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="tanggal" value="<?php echo e($item->tanggal ?? ''); ?>" placeholder="Contoh: 15 Mei 2026" class="form-control rounded-pill border-2 px-3 small">
                                        </div>
                                        
                                        <div class="mb-3">
                                            <label class="form-label small fw-bold text-secondary">Tanggal, Nama & Paraf Kader</label>
                                            <input type="text" name="kader_info" value="<?php echo e($item->kader_info ?? ''); ?>" placeholder="Contoh: 15/05/26 - Kader Susi (Paraf)" class="form-control rounded-pill border-2 px-3 small">
                                        </div>

                                        <button type="submit" class="btn btn-primary rounded-pill w-100 shadow-xs fw-semibold py-2">
                                            <i class="bi bi-save2-fill me-1"></i> Simpan Kehadiran <?php echo e($i); ?>
...
<?php echo $__env->make('pengguna.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MomSpire\resources\views\pengguna\kia-kelas-ibu.blade.php ENDPATH**/ ?>