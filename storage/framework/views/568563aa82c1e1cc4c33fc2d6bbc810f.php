    ...
    <div class="card role-card hero-role detail-hero mb-4">
        <div class="card-body p-4 p-lg-5">
            <div class="detail-topbar">
                ...
                <form method="GET" action="<?php echo e(route('dokter.pengguna')); ?>" class="detail-search d-flex gap-2 flex-grow-1 justify-content-lg-end">
                    ...
                    <div class="col-lg-6">
                        <div class="pengguna-row">
                            ...
                            <div class="d-flex gap-2 mt-3">
                                ...
                                <a href="<?php echo e(route('dokter.pengguna.bukuKIA.input', $pengguna->id)); ?>" class="btn btn-role-outline btn-sm">
...
<div class="modal fade" id="tambahJadwalModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <form method="POST" action="<?php echo e(route('dokter.jadwal.store')); ?>">
                <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('dokter.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MomSpire\resources\views/dokter/detailPengguna.blade.php ENDPATH**/ ?>