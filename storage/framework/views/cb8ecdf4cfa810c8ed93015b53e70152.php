<?php $__env->startSection('title', 'Pemantauan Bayi 6 - 12 Bulan - MomSpire'); ?>
<?php $__env->startSection('header_title', 'Bayi Umur 6 - 12 Bulan'); ?>
<?php $__env->startSection('header_subtitle', 'Catat pemantauan bulanan kesehatan dan perkembangan si kecil secara mandiri dari bulan ke-6 hingga ke-12.'); ?>

<?php $__env->startSection('content'); ?>
<div class="row g-4" x-data="{ activeTab: '<?php echo e(session('active_tab', 'bulanan')); ?>', activeMonth: <?php echo e(session('active_month', 6)); ?> }">
    <!-- Info Banner -->
    <div class="col-12">
        ...
        <div class="card border-0 shadow-sm rounded-4 overflow-hidden h-100">
            <div class="card-header bg-white border-0 p-4 pb-0 d-flex justify-content-between align-items-center flex-wrap gap-2">
                ...
                <div class="d-flex gap-2 flex-wrap">
                    <?php $__currentLoopData = range(6, 11); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="card-body p-4">
                <?php $__currentLoopData = range(6, 11); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div x-show="activeMonth === <?php echo e($m); ?>" x-transition>
                        ...
                        <form action="<?php echo e(route('pengguna.bulanan_bayi_12.save')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="list-group">
                                        ...
                                        <div class="p-3 bg-light rounded-3 mt-2 border-primary border-start border-4">
                                            ...
                                            <input type="text" name="paraf_kader_nakes" value="<?php echo e($item->paraf_kader_nakes ?? ''); ?>" class="form-control bg-white" placeholder="Contoh: 12/08/26 - Kader Rahma">
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="col-12" x-show="activeTab === 'perkembangan9'" x-transition>
        <div class="card border-0 shadow-sm rounded-4 overflow-hidden h-100">
            ...
            <div class="card-body p-4">
                <?php $p9 = $perkembangan9 ?? null; ?>
                <form action="<?php echo e(route('pengguna.perkembangan_bayi_9_bulan.save')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="duduk_mandiri" value="1" class="form-check-input fs-4" <?php echo e((isset($p9->duduk_mandiri) && $p9->duduk_mandiri == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="duduk_mandiri" value="0" class="form-check-input fs-4" <?php echo e((isset($p9->duduk_mandiri) && $p9->duduk_mandiri == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="tengkurap_dada" value="1" class="form-check-input fs-4" <?php echo e((isset($p9->tengkurap_dada) && $p9->tengkurap_dada == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="tengkurap_dada" value="0" class="form-check-input fs-4" <?php echo e((isset($p9->tengkurap_dada) && $p9->tengkurap_dada == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="merangkak" value="1" class="form-check-input fs-4" <?php echo e((isset($p9->merangkak) && $p9->merangkak == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="merangkak" value="0" class="form-check-input fs-4" <?php echo e((isset($p9->merangkak) && $p9->merangkak == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="pindah_benda" value="1" class="form-check-input fs-4" <?php echo e((isset($p9->pindah_benda) && $p9->pindah_benda == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="pindah_benda" value="0" class="form-check-input fs-4" <?php echo e((isset($p9->pindah_benda) && $p9->pindah_benda == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="pungut_2_benda" value="1" class="form-check-input fs-4" <?php echo e((isset($p9->pungut_2_benda) && $p9->pungut_2_benda == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="pungut_2_benda" value="0" class="form-check-input fs-4" <?php echo e((isset($p9->pungut_2_benda) && $p9->pungut_2_benda == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="pungut_kacang" value="1" class="form-check-input fs-4" <?php echo e((isset($p9->pungut_kacang) && $p9->pungut_kacang == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="pungut_kacang" value="0" class="form-check-input fs-4" <?php echo e((isset($p9->pungut_kacang) && $p9->pungut_kacang == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="bersuara_tanpa_arti" value="1" class="form-check-input fs-4" <?php echo e((isset($p9->bersuara_tanpa_arti) && $p9->bersuara_tanpa_arti == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="bersuara_tanpa_arti" value="0" class="form-check-input fs-4" <?php echo e((isset($p9->bersuara_tanpa_arti) && $p9->bersuara_tanpa_arti == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="cari_mainan" value="1" class="form-check-input fs-4" <?php echo e((isset($p9->cari_mainan) && $p9->cari_mainan == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="cari_mainan" value="0" class="form-check-input fs-4" <?php echo e((isset($p9->cari_mainan) && $p9->cari_mainan == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="tepuk_tangan" value="1" class="form-check-input fs-4" <?php echo e((isset($p9->tepuk_tangan) && $p9->tepuk_tangan == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="tepuk_tangan" value="0" class="form-check-input fs-4" <?php echo e((isset($p9->tepuk_tangan) && $p9->tepuk_tangan == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="lempar_benda" value="1" class="form-check-input fs-4" <?php echo e((isset($p9->lempar_benda) && $p9->lempar_benda == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="lempar_benda" value="0" class="form-check-input fs-4" <?php echo e((isset($p9->lempar_benda) && $p9->lempar_benda == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="makan_kue" value="1" class="form-check-input fs-4" <?php echo e((isset($p9->makan_kue) && $p9->makan_kue == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="makan_kue" value="0" class="form-check-input fs-4" <?php echo e((isset($p9->makan_kue) && $p9->makan_kue == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
    ...
    <div class="col-12" x-show="activeTab === 'perkembangan12'" x-transition>
        <div class="card border-0 shadow-sm rounded-4 overflow-hidden h-100">
            ...
            <div class="card-body p-4">
                <?php $p12 = $perkembangan12 ?? null; ?>
                <form action="<?php echo e(route('pengguna.perkembangan_bayi_12_bulan.save')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover align-middle mb-4">
                            <thead class="table-warning text-dark text-center">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="angkat_badan_berdiri" value="1" class="form-check-input fs-4" <?php echo e((isset($p12->angkat_badan_berdiri) && $p12->angkat_badan_berdiri == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="angkat_badan_berdiri" value="0" class="form-check-input fs-4" <?php echo e((isset($p12->angkat_badan_berdiri) && $p12->angkat_badan_berdiri == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-center fw-bold bg-light">2</td>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="belajar_berdiri" value="1" class="form-check-input fs-4" <?php echo e((isset($p12->belajar_berdiri) && $p12->belajar_berdiri == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="belajar_berdiri" value="0" class="form-check-input fs-4" <?php echo e((isset($p12->belajar_berdiri) && $p12->belajar_berdiri == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-center fw-bold bg-light">3</td>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="jalan_dituntun" value="1" class="form-check-input fs-4" <?php echo e((isset($p12->jalan_dituntun) && $p12->jalan_dituntun == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="jalan_dituntun" value="0" class="form-check-input fs-4" <?php echo e((isset($p12->jalan_dituntun) && $p12->jalan_dituntun == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-center fw-bold bg-light">4</td>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="ulur_tangan_raih" value="1" class="form-check-input fs-4" <?php echo e((isset($p12->ulur_tangan_raih) && $p12->ulur_tangan_raih == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="ulur_tangan_raih" value="0" class="form-check-input fs-4" <?php echo e((isset($p12->ulur_tangan_raih) && $p12->ulur_tangan_raih == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-center fw-bold bg-light">5</td>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="genggam_pensil" value="1" class="form-check-input fs-4" <?php echo e((isset($p12->genggam_pensil) && $p12->genggam_pensil == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="genggam_pensil" value="0" class="form-check-input fs-4" <?php echo e((isset($p12->genggam_pensil) && $p12->genggam_pensil == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-center fw-bold bg-light">6</td>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="masuk_benda_mulut" value="1" class="form-check-input fs-4" <?php echo e((isset($p12->masuk_benda_mulut) && $p12->masuk_benda_mulut == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="masuk_benda_mulut" value="0" class="form-check-input fs-4" <?php echo e((isset($p12->masuk_benda_mulut) && $p12->masuk_benda_mulut == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-center fw-bold bg-light">7</td>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="tiru_bunyi" value="1" class="form-check-input fs-4" <?php echo e((isset($p12->tiru_bunyi) && $p12->tiru_bunyi == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="tiru_bunyi" value="0" class="form-check-input fs-4" <?php echo e((isset($p12->tiru_bunyi) && $p12->tiru_bunyi == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-center fw-bold bg-light">8</td>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="sebut_2_suku_kata" value="1" class="form-check-input fs-4" <?php echo e((isset($p12->sebut_2_suku_kata) && $p12->sebut_2_suku_kata == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="sebut_2_suku_kata" value="0" class="form-check-input fs-4" <?php echo e((isset($p12->sebut_2_suku_kata) && $p12->sebut_2_suku_kata == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-center fw-bold bg-light">9</td>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="eksplorasi_sekitar" value="1" class="form-check-input fs-4" <?php echo e((isset($p12->eksplorasi_sekitar) && $p12->eksplorasi_sekitar == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="eksplorasi_sekitar" value="0" class="form-check-input fs-4" <?php echo e((isset($p12->eksplorasi_sekitar) && $p12->eksplorasi_sekitar == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-center fw-bold bg-light">10</td>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="reaksi_panggilan" value="1" class="form-check-input fs-4" <?php echo e((isset($p12->reaksi_panggilan) && $p12->reaksi_panggilan == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="reaksi_panggilan" value="0" class="form-check-input fs-4" <?php echo e((isset($p12->reaksi_panggilan) && $p12->reaksi_panggilan == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-center fw-bold bg-light">11</td>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="bermain_cilukba" value="1" class="form-check-input fs-4" <?php echo e((isset($p12->bermain_cilukba) && $p12->bermain_cilukba == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="bermain_cilukba" value="0" class="form-check-input fs-4" <?php echo e((isset($p12->bermain_cilukba) && $p12->bermain_cilukba == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="kenal_keluarga" value="1" class="form-check-input fs-4" <?php echo e((isset($p12->kenal_keluarga) && $p12->kenal_keluarga == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="kenal_keluarga" value="0" class="form-check-input fs-4" <?php echo e((isset($p12->kenal_keluarga) && $p12->kenal_keluarga == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
...
<?php echo $__env->make('pengguna.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MomSpire\resources\views\pengguna\kia-bulanan-bayi-12.blade.php ENDPATH**/ ?>