<?php $__env->startSection('title', 'Pemantauan Ibu Nifas - MomSpire'); ?>
<?php $__env->startSection('header_title', 'Pemantauan Ibu Nifas'); ?>
<?php $__env->startSection('header_subtitle', 'Catat kondisi kesehatan harian Ibu selama masa nifas (hari ke-1 sampai ke-42).'); ?>
...
<div class="row g-4 animate__animated animate__fadeIn" x-data="nifasApp()">
    ...
    <div class="col-12 col-xl-7">
        <form action="<?php echo e(route('pengguna.nifas.save')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('pengguna.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MomSpire\resources\views\pengguna\kia-pemantauan-nifas.blade.php ENDPATH**/ ?>