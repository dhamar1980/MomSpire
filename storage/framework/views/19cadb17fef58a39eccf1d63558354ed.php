	...
	<aside class="admin-sidebar" id="adminSidebar">
		...
		<nav class="sidebar-nav">
			<div class="nav-section">
				...
				<a href="<?php echo e(route('admin.articles')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.articles') ? 'active' : ''); ?>">
					<i class="bi bi-journal-text"></i>
					<span>Manajemen Artikel</span>
				</a>
				<a href="<?php echo e(route('admin.kia')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.kia') || request()->routeIs('admin.kia.pdf') ? 'active' : ''); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\MomSpire\resources\views\Admin\master.blade.php ENDPATH**/ ?>