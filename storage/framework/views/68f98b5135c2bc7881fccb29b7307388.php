<?php $__env->startSection('title', 'Status Kehamilan - MomSpire'); ?>
<?php $__env->startSection('header_title', 'Status Kehamilan'); ?>
	...
	<div class="status-shell">
		<div class="status-hero">
			<div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-3 position-relative" style="z-index: 1;">
				<div>
					<h2 class="mb-2"><?php echo e($isHamil ? 'Pemantauan kehamilan' : 'Status belum menunjukkan kehamilan aktif'); ?></h2>
					<p>
				...
				<div class="text-end">
					<div class="status-chip mb-2"><i class="bi bi-person-heart"></i><?php echo e($pengguna->name); ?></div>
			...
			<div class="row g-3 position-relative" style="z-index: 1;">
				<?php $__currentLoopData = $ringkasan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<div class="col-12 col-md-6 col-xl-4">
						<div class="status-card h-100">
							<div class="status-icon <?php echo e($item['tone']); ?>">
								<i class="bi <?php echo e($item['icon']); ?>"></i>
							</div>
							<div class="status-card-label mb-1"><?php echo e($item['label']); ?></div>
							<div class="status-card-value"><?php echo e($item['value']); ?></div>
						</div>
					</div>
		...
		<div class="row g-4 mb-4">
			<div class="col-12 col-xl-7">
				<div class="status-panel h-100">
					<div class="d-flex align-items-start justify-content-between gap-3 mb-4">
						...
						<span class="history-badge"><?php echo e($isHamil ? 'Aktif' : 'Tidak Aktif'); ?></span>
					</div>
						...
						<div class="row g-3">
							...
							<div class="col-md-6">
								<div class="history-item h-100">
									...
									<div class="fw-bold fs-5">Kehamilan ke-<?php echo e($kehamilanKe); ?></div>
			...
			<div class="col-12 col-xl-5">
				<div class="status-panel h-100">
					...
					<?php if(count($riwayatKontrol)): ?>
						<div class="d-grid gap-3">
							<?php $__currentLoopData = $riwayatKontrol; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<div class="history-item">
									<div class="d-flex justify-content-between align-items-start gap-3">
										<div>
											<div class="fw-bold mb-1"><?php echo e($item['judul']); ?></div>
											<div class="text-muted small"><?php echo e($item['waktu']); ?></div>
										</div>
										<span class="history-badge"><?php echo e($item['status']); ?></span>
									</div>
									<p class="mb-0 text-muted small mt-3"><?php echo e($item['catatan']); ?></p>
								</div>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						</div>
					<?php else: ?>
		...
		<div class="row g-4">
			<div class="col-12 col-lg-12">
				<div class="status-panel">
					...
					<?php if(count($riwayatKehamilan)): ?>
						<div class="timeline-line d-grid gap-3">
							<?php $__currentLoopData = $riwayatKehamilan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<div class="history-item position-relative">
									<div class="d-flex flex-wrap justify-content-between align-items-start gap-2">
										<div>
											<div class="fw-bold"><?php echo e($item['judul']); ?></div>
											<div class="text-muted small"><?php echo e($item['tanggal']); ?></div>
										</div>
										<span class="history-badge"><?php echo e($item['status']); ?></span>
									</div>
								</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('pengguna.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MomSpire\resources\views\pengguna\statusKehamilan.blade.php ENDPATH**/ ?>