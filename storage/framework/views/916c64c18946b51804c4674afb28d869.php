<?php $__env->startSection('title', 'Pemantauan Warna Tinja Bayi - MomSpire'); ?>
<?php $__env->startSection('header_title', 'Warna Tinja Bayi'); ?>
<?php $__env->startSection('header_subtitle', 'Periksa warna tinja bayi Anda setiap hari untuk deteksi dini Atresia Bilier (sumbatan kandung empedu).'); ?>
    ...
    <div class="col-12 col-lg-8">
        <div class="card border-0 shadow-sm rounded-4 overflow-hidden h-100">
            ...
            <div class="card-body p-4">
                <?php $t = $dataKia->warnaTinja; ?>
                <form action="<?php echo e(route('pengguna.warna_tinja.save')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                        ...
                        <table class="table table-bordered align-middle text-center mb-4">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="tanggal_2_minggu" value="<?php echo e($t->tanggal_2_minggu ?? ''); ?>" class="form-control text-center" placeholder="Tgl/Bln/Thn">
                                    </td>
                                    <td>
                                        <input type="text" name="tanggal_1_bulan" value="<?php echo e($t->tanggal_1_bulan ?? ''); ?>" class="form-control text-center" placeholder="Tgl/Bln/Thn">
                                    </td>
                                    <td>
                                        <input type="text" name="tanggal_2_4_bulan" value="<?php echo e($t->tanggal_2_4_bulan ?? ''); ?>" class="form-control text-center" placeholder="Tgl/Bln/Thn">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <select name="nomor_2_minggu" class="form-select text-center fw-bold">
                                            ...
                                            <?php $__currentLoopData = range(1, 7); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($n); ?>" <?php echo e(($t->nomor_2_minggu ?? '') == $n ? 'selected' : ''); ?>>Nomor <?php echo e($n); ?></option>
                                    ...
                                    <td>
                                        <select name="nomor_1_bulan" class="form-select text-center fw-bold">
                                            <option value="">- Pilih -</option>
                                            <?php $__currentLoopData = range(1, 7); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($n); ?>" <?php echo e(($t->nomor_1_bulan ?? '') == $n ? 'selected' : ''); ?>>Nomor <?php echo e($n); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </td>
                                    <td>
                                        <select name="nomor_2_4_bulan" class="form-select text-center fw-bold">
                                            <option value="">- Pilih -</option>
                                            <?php $__currentLoopData = range(1, 7); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($n); ?>" <?php echo e(($t->nomor_2_4_bulan ?? '') == $n ? 'selected' : ''); ?>>Nomor <?php echo e($n); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </td>
                                </tr>
...
<?php echo $__env->make('pengguna.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MomSpire\resources\views\pengguna\kia-warna-tinja.blade.php ENDPATH**/ ?>