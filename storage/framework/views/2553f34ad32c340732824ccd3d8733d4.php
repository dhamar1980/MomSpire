	...
	<aside class="admin-sidebar" id="adminSidebar">
		...
		<nav class="sidebar-nav">
			<div class="nav-section">
				...
				<a href="<?php echo e(route('bidan.dashboard')); ?>" class="nav-link <?php echo e(request()->routeIs('bidan.dashboard') ? 'active' : ''); ?>">
					<i class="bi bi-grid-1x2-fill"></i>
					<span>Dashboard</span>
				</a>
				<a href="<?php echo e(route('bidan.pengguna')); ?>" class="nav-link <?php echo e(request()->routeIs('bidan.pengguna*') ? 'active' : ''); ?>">
					<i class="bi bi-person-fill"></i>
					<span>Detail Pengguna</span>
				</a>
				<a href="<?php echo e(route('bidan.konsultasi')); ?>" class="nav-link <?php echo e(request()->routeIs('bidan.konsultasi*') ? 'active' : ''); ?>">
			...
			<div class="nav-section">
				...
				<a href="<?php echo e(route('bidan.settings')); ?>" class="nav-link <?php echo e(request()->routeIs('bidan.settings') ? 'active' : ''); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\MomSpire\resources\views/bidan/master.blade.php ENDPATH**/ ?>