...
<?php $__env->startSection('content'); ?>
	<div class="pengguna-dashboard-shell">
		...
		<a href="<?php echo e(route('pengguna.status_kehamilan')); ?>" class="text-decoration-none text-reset">
			...
			<div class="card-body" style="padding: 12px;">
				<div class="row align-items-center g-2">
					<div class="col-12 col-lg-7 d-flex flex-column justify-content-between">
						<div>
							<h4 class="fw-bold mb-1" style="font-size: clamp(1.25rem, 5vw, 1.6rem); line-height: 1.2;"><?php echo e($greet); ?>, <?php echo e($displayName); ?></h4>
							<div class="hero-stats-row">
								<div class="hero-stat">
									<small class="text-muted d-block" style="font-size: .74rem; margin-bottom: 0.3rem;">Status Kehamilan</small>
									<div class="fw-bold" style="font-size: .98rem; color: #1e293b;"><?php echo e(($pengguna->is_hamil ?? auth()->user()->is_hamil) ? 'Sedang Hamil' : 'Tidak Hamil'); ?></div>
								</div>
								<div class="hero-stat">
									<small class="text-muted d-block" style="font-size: .74rem; margin-bottom: 0.3rem;">HPL</small>
									<div class="fw-bold" style="font-size: .98rem; color: #1e293b;"><?php echo e(auth()->user()->hpl ?? '—'); ?></div>
								</div>
								<div class="hero-stat">
									<small class="text-muted d-block" style="font-size: .74rem; margin-bottom: 0.3rem;">Risiko Kehamilan</small>
									<div class="fw-bold" style="font-size: .98rem; color: #1e293b;"><?php echo e(auth()->user()->resiko ?? 'Normal'); ?></div>
								</div>
								<div class="hero-stat">
									<small class="text-muted d-block" style="font-size: .74rem; margin-bottom: 0.3rem;">GPA</small>
									<div class="fw-bold" style="font-size: .98rem; color: #1e293b;"><?php echo e(auth()->user()->gpa ?? '0/0/0'); ?></div>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="hero-figure">
							<div class="hero-hearts-container">
								<div class="mom-hug-wrap" aria-hidden="true">
									<img src="<?php echo e(asset('foto/mom.jpg')); ?>" alt="Ibu memeluk anak" class="mom-hug-svg mom-sway" style="border-radius: 12px; object-fit: cover;" />
								</div>
	...
	<div class="row g-2 mb-4 mt-3">
		<div class="col-12 col-lg-6">
			<a href="<?php echo e(route('pengguna.kalkulator')); ?>" class="card dashboard-card-modern action-shell d-block text-decoration-none" style="min-height: 160px; overflow: hidden;">
				<div class="card-body d-flex flex-column flex-sm-row gap-3 align-items-start align-sm-items-center" style="padding: 16px;">
					<div class="action-illustration buku">
						<img src="<?php echo e(asset('foto/kalkulator.jpg')); ?>" alt="Kalkulator Gizi" style="width:100%; height:100%; object-fit:cover; border-radius:12px;">
					</div>
		...
		<div class="col-12 col-lg-6">
			<a href="<?php echo e(route('pengguna.buku_kia')); ?>" class="card dashboard-card-modern action-shell d-block text-decoration-none" style="min-height: 160px; overflow: hidden;">
				<div class="card-body d-flex flex-column flex-sm-row gap-3 align-items-start align-sm-items-center" style="padding: 16px;">
					<div class="action-illustration buku">
						<img src="<?php echo e(asset('foto/BUKU KIA.jpg')); ?>" alt="Buku KIA" style="width:100%; height:100%; object-fit:cover; border-radius:24px;">
					</div>
					<div class="flex-grow-1">
					...
					<div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
						...
						<?php if(count($jadwalList) > 0): ?>
							<span class="badge bg-pink-light text-pink-primary rounded-pill">
								<i class="bi bi-calendar-check"></i> <?php echo e(count($jadwalList)); ?> jadwal
							</span>
						<?php endif; ?>
					</div>
				</div>
...
<?php echo $__env->make('pengguna.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MomSpire\resources\views\pengguna\dashboardPengguna.blade.php ENDPATH**/ ?>