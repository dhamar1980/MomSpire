<?php $__env->startSection('title', 'Dashboard Dokter - MomSpire'); ?>
		...
		<div class="card role-card hero-role">
			<div class="card-body p-4 p-lg-5">
				<div class="d-flex justify-content-between align-items-start">
					<div>
						<h2 class="fw-bold mb-2 dash-hero-title"><?php echo e($greeting); ?>, Dokter <?php echo e(auth()->user()->name); ?></h2>
...
<?php echo $__env->make('dokter.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MomSpire\resources\views\dokter\dashboardDokter.blade.php ENDPATH**/ ?>