...
<?php $__env->startSection('header_action'); ?>
	<a href="<?php echo e(route('dokter.pengguna')); ?>" class="btn btn-back-page">
        ...
        <div class="bp-card-body">
                    ...
                    <?php $__currentLoopData = $entries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bp-entry-item">
                            ...
                            <div class="bp-entry-actions">
                                ...
                                <form action="<?php echo e(route('dokter.pengguna.bukuKIA.destroy', $entry->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Yakin hapus catatan ini?')">
                                    <?php echo csrf_field(); ?>
            ...
            <div id="tab-tambah-buku" class="bp-tab-content">
                ...
                <div class="bp-form-card">
                    ...
                    <form method="POST" action="<?php echo e(route('dokter.pengguna.bukuKIA.store', $pengguna->id)); ?>">
                        <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('dokter.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MomSpire\resources\views\dokter\bukuKIAPengguna.blade.php ENDPATH**/ ?>