	...
	<aside class="admin-sidebar" id="adminSidebar">
		...
		<nav class="sidebar-nav">
			<div class="nav-section">
				...
				<a href="<?php echo e(route('pengguna.dashboard')); ?>" class="nav-link <?php echo e(request()->routeIs('pengguna.dashboard') ? 'active' : ''); ?>">
					<i class="bi bi-grid-1x2-fill"></i>
					<span>Dashboard</span>
				</a>
				<a href="<?php echo e(route('pengguna.artikel')); ?>" class="nav-link <?php echo e(request()->routeIs('pengguna.artikel') ? 'active' : ''); ?>">
					<i class="bi bi-journal-text"></i>
					<span>Artikel Edukasi</span>
				</a>
				<a href="<?php echo e(route('pengguna.konsultasi')); ?>" class="nav-link <?php echo e(request()->routeIs('pengguna.konsultasi') ? 'active' : ''); ?>">
					<i class="bi bi-chat-dots-fill"></i>
					<span>Konsultasi</span>
				</a>
				<a href="<?php echo e(route('pengguna.ttd')); ?>"
					class="nav-link <?php echo e(request()->routeIs('pengguna.ttd') ? 'active' : ''); ?>">
					<i class="bi bi-calendar-check-fill"></i>
					<span>Catat Minum TTD</span>
				</a>
				<a href="<?php echo e(route('pengguna.pemantauan')); ?>"
					class="nav-link <?php echo e(request()->routeIs('pengguna.pemantauan') ? 'active' : ''); ?>">
					<i class="bi bi-heart-pulse-fill"></i>
					<span>Pemantauan Ibu Hamil</span>
				</a>
				<a href="<?php echo e(route('pengguna.kelas_ibu')); ?>"
					class="nav-link <?php echo e(request()->routeIs('pengguna.kelas_ibu') ? 'active' : ''); ?>">
					<i class="bi bi-people-fill"></i>
					<span>Kelas Ibu Hamil</span>
				</a>
				<a href="<?php echo e(route('pengguna.persiapan')); ?>"
					class="nav-link <?php echo e(request()->routeIs('pengguna.persiapan') ? 'active' : ''); ?>">
					<i class="bi bi-journal-check"></i>
					<span>Persiapan Melahirkan</span>
				</a>
				<a href="<?php echo e(route('pengguna.nifas')); ?>"
					class="nav-link <?php echo e(request()->routeIs('pengguna.nifas') ? 'active' : ''); ?>">
					<i class="bi bi-calendar2-heart"></i>
					<span>Pemantauan Ibu Nifas</span>
				</a>
				<a href="<?php echo e(route('pengguna.kb')); ?>"
					class="nav-link <?php echo e(request()->routeIs('pengguna.kb') ? 'active' : ''); ?>">
					<i class="bi bi-people"></i>
					<span>Keluarga Berencana</span>
				</a>
				<a href="<?php echo e(route('pengguna.bayi')); ?>"
					class="nav-link <?php echo e(request()->routeIs('pengguna.bayi') ? 'active' : ''); ?>">
					<i class="bi bi-person-hearts"></i>
					<span>Bayi Baru Lahir</span>
				</a>
				<a href="<?php echo e(route('pengguna.pemantauan_bayi')); ?>"
					class="nav-link <?php echo e(request()->routeIs('pengguna.pemantauan_bayi') ? 'active' : ''); ?>">
					<i class="bi bi-calendar2-check"></i>
					<span>Pemantauan Bayi 0-28 Hari</span>
				</a>
				<a href="<?php echo e(route('pengguna.warna_tinja')); ?>"
					class="nav-link <?php echo e(request()->routeIs('pengguna.warna_tinja') ? 'active' : ''); ?>">
					<i class="bi bi-palette-fill"></i>
					<span>Warna Tinja Bayi</span>
				</a>
				<a href="<?php echo e(route('pengguna.kelas_balita')); ?>"
					class="nav-link <?php echo e(request()->routeIs('pengguna.kelas_balita') ? 'active' : ''); ?>">
					<i class="bi bi-people-fill"></i>
					<span>Kelas Ibu Balita</span>
				</a>
				<a href="<?php echo e(route('pengguna.mingguan_bayi')); ?>"
					class="nav-link <?php echo e(request()->routeIs('pengguna.mingguan_bayi') ? 'active' : ''); ?>">
					<i class="bi bi-heart-pulse-fill"></i>
					<span>Bayi 29 Hari - 3 Bulan</span>
				</a>
				<a href="<?php echo e(route('pengguna.bulanan_bayi')); ?>"
					class="nav-link <?php echo e(request()->routeIs('pengguna.bulanan_bayi') ? 'active' : ''); ?>">
					<i class="bi bi-calendar-heart-fill"></i>
					<span>Bayi Umur 3 - 6 Bulan</span>
				</a>
				<a href="<?php echo e(route('pengguna.bulanan_bayi_12')); ?>"
					class="nav-link <?php echo e(request()->routeIs('pengguna.bulanan_bayi_12') ? 'active' : ''); ?>">
					<i class="bi bi-calendar2-check-fill"></i>
					<span>Bayi Umur 6 - 12 Bulan</span>
				</a>
				<a href="<?php echo e(route('pengguna.bulanan_anak_24')); ?>"
					class="nav-link <?php echo e(request()->routeIs('pengguna.bulanan_anak_24') ? 'active' : ''); ?>">
					<i class="bi bi-calendar2-star-fill"></i>
					<span>Anak Umur 1 - 2 Tahun</span>
				</a>
				<a href="<?php echo e(route('pengguna.bulanan_anak_72')); ?>"
					class="nav-link <?php echo e(request()->routeIs('pengguna.bulanan_anak_72') ? 'active' : ''); ?>">
					<i class="bi bi-calendar3-range-fill"></i>
					<span>Anak Umur 2 - 6 Tahun</span>
				</a>
				<a href="<?php echo e(route('pengguna.kesehatan_lingkungan')); ?>"
					class="nav-link <?php echo e(request()->routeIs('pengguna.kesehatan_lingkungan') ? 'active' : ''); ?>">
			...
			<div class="nav-section">
				...
				<a href="<?php echo e(route('pengguna.pengaturan')); ?>" class="nav-link <?php echo e(request()->routeIs('pengguna.pengaturan') ? 'active' : ''); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\MomSpire\resources\views/pengguna/master.blade.php ENDPATH**/ ?>