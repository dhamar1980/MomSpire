<?php $__env->startSection('title', 'Pengaturan Akun - MomSpire'); ?>
        ...
        <div class="row g-4 mb-4 align-items-start">
            ...
            <div class="col-lg-8">
                <div class="settings-section h-100">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('pengguna.settings.profile')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label class="form-label">Nama Lengkap</label>
                                    <input type="text" class="form-control" name="name" value="<?php echo e(old('name', $pengguna->name ?? '')); ?>" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Email</label>
                                    <input type="email" class="form-control" name="email" value="<?php echo e(old('email', $pengguna->email ?? '')); ?>" required>
                                </div>
                                <div class="col-12">
                                    <label class="form-label">No. Telepon</label>
                                    <input type="tel" class="form-control" name="no_telp" value="<?php echo e(old('no_telp', $pengguna->no_telp ?? '')); ?>" placeholder="08xxxxxxxxxx">
                                </div>
                            </div>
                            <div class="mt-4">
        ...
        <div class="row g-4 mb-4 align-items-start">
            ...
            <div class="col-lg-8">
                <div class="settings-section h-100">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('pengguna.settings.password')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="mb-3">
                ...
                <div class="settings-section h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div id="twoFactorEnabledState" class="<?php echo e($twoFactorEnabled ? '' : 'd-none'); ?>">
                            ...
                            <div id="twoFactorConfirmBox" class="<?php echo e($twoFactorEnabled && !$twoFactorConfirmed && $requiresTwoFactorConfirmation ? '' : 'd-none'); ?> mb-3">
                                <div class="row g-2 align-items-end">
                                    <div class="col-md-8">
                                        <label class="form-label">Kode OTP</label>
                                        <input type="text" class="form-control" id="twoFactorOtpCode" placeholder="Masukkan kode dari authenticator">
                                    </div>
                                    <div class="col-md-4">
                                        <button type="button" class="btn btn-primary-custom w-100" id="confirmTwoFactorBtn">Konfirmasi</button>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table class="table align-middle">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $browserSessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $session): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td>
                                                    <div class="fw-semibold"><?php echo e($session['agent']['platform'] ?: 'Unknown'); ?> - <?php echo e($session['agent']['browser'] ?: 'Unknown'); ?></div>
...
<?php echo $__env->make('pengguna.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MomSpire\resources\views\pengguna\pengaturan.blade.php ENDPATH**/ ?>