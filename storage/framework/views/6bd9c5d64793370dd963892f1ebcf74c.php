<?php $__env->startSection('title', 'Konsultasi Bidan - MomSpire'); ?>
<?php $__env->startSection('header_title', 'Konsultasi'); ?>
<?php $__env->startSection('header_subtitle', 'Balas pesan pengguna dari ruang chat bidan.'); ?>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $conversations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conversation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="wa-conversation-item <?php echo e($selectedConversation && $selectedConversation->id === $conversation->id ? 'active' : ''); ?>"
                        ...
                        <div class="wa-conversation-avatar">
                            ...
                            <span class="wa-online-dot <?php echo e($isOnline ? 'online' : 'offline'); ?>"></span>
                        </div>
...
<script>
    ...
    let currentPenggunaOnline = <?php echo e($currentPenggunaOnline ? 'true' : 'false'); ?>;
    let currentPenggunaLastSeen = <?php echo json_encode($currentPenggunaLastSeen, 15, 512) ?>;
    let firebaseUnsubscribe = null;

    const bidanId = <?php echo e(auth()->id()); ?>;
    const bidanName = <?php echo json_encode(auth()->user()->name ?? 'Bidan', 15, 512) ?>;

    <?php if($selectedConversation): ?>
        window.addEventListener('load', function() {
            selectConversation(<?php echo e($selectedConversation->id); ?>, <?php echo json_encode($selectedConversation->pengguna->name ?? 'Pengguna', 15, 512) ?>, currentPenggunaOnline, currentPenggunaLastSeen);
        });
    <?php endif; ?>
    ...
    async function loadChat(conversationId, name) {
        try {
            const response = await fetch(`<?php echo e(url('/bidan/konsultasi')); ?>/${conversationId}/messages`);
    ...
    async function sendMessage() {
        ...
        try {
            const response = await fetch('<?php echo e(route("bidan.konsultasi.send_message")); ?>', {
                method: 'POST',
                headers: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('bidan.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MomSpire\resources\views\bidan\konsultasi.blade.php ENDPATH**/ ?>