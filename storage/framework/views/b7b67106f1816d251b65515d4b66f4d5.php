<?php $__env->startSection('title', 'Pemantauan Bayi 3 - 6 Bulan - MomSpire'); ?>
<?php $__env->startSection('header_title', 'Bayi Umur 3 - 6 Bulan'); ?>
<?php $__env->startSection('header_subtitle', 'Catat pemantauan bulanan kesehatan dan perkembangan si kecil secara mandiri.'); ?>

<?php $__env->startSection('content'); ?>
<div class="row g-4" x-data="{ activeTab: '<?php echo e(session('active_tab', 'bulanan')); ?>', activeMonth: <?php echo e(session('active_month', 3)); ?> }">
    <!-- Info Banner -->
    <div class="col-12">
        ...
        <div class="card border-0 shadow-sm rounded-4 overflow-hidden h-100">
            <div class="card-header bg-white border-0 p-4 pb-0 d-flex justify-content-between align-items-center flex-wrap gap-2">
                ...
                <div class="d-flex gap-2">
                    <?php $__currentLoopData = [3, 4, 5]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="card-body p-4">
                <?php $__currentLoopData = [3, 4, 5]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div x-show="activeMonth === <?php echo e($m); ?>" x-transition>
                        ...
                        <form action="<?php echo e(route('pengguna.bulanan_bayi.save')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="list-group">
                                        ...
                                        <div class="p-3 bg-light rounded-3 mt-2 border-primary border-start border-4">
                                            ...
                                            <input type="text" name="paraf_kader_nakes" value="<?php echo e($item->paraf_kader_nakes ?? ''); ?>" class="form-control bg-white" placeholder="Contoh: 15/07/26 - Bidan Ratna">
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="col-12" x-show="activeTab === 'perkembangan'" x-transition>
        <div class="card border-0 shadow-sm rounded-4 overflow-hidden h-100">
            ...
            <div class="card-body p-4">
                <?php $p = $perkembangan; ?>
                <form action="<?php echo e(route('pengguna.perkembangan_bayi_6_bulan.save')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="berbalik" value="1" class="form-check-input fs-4" <?php echo e((isset($p->berbalik) && $p->berbalik == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="berbalik" value="0" class="form-check-input fs-4" <?php echo e((isset($p->berbalik) && $p->berbalik == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="kepala_tegak_90" value="1" class="form-check-input fs-4" <?php echo e((isset($p->kepala_tegak_90) && $p->kepala_tegak_90 == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="kepala_tegak_90" value="0" class="form-check-input fs-4" <?php echo e((isset($p->kepala_tegak_90) && $p->kepala_tegak_90 == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="kepala_stabil" value="1" class="form-check-input fs-4" <?php echo e((isset($p->kepala_stabil) && $p->kepala_stabil == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="kepala_stabil" value="0" class="form-check-input fs-4" <?php echo e((isset($p->kepala_stabil) && $p->kepala_stabil == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="genggam_mainan" value="1" class="form-check-input fs-4" <?php echo e((isset($p->genggam_mainan) && $p->genggam_mainan == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="genggam_mainan" value="0" class="form-check-input fs-4" <?php echo e((isset($p->genggam_mainan) && $p->genggam_mainan == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="raih_benda" value="1" class="form-check-input fs-4" <?php echo e((isset($p->raih_benda) && $p->raih_benda == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="raih_benda" value="0" class="form-check-input fs-4" <?php echo e((isset($p->raih_benda) && $p->raih_benda == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="amati_tangan" value="1" class="form-check-input fs-4" <?php echo e((isset($p->amati_tangan) && $p->amati_tangan == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="amati_tangan" value="0" class="form-check-input fs-4" <?php echo e((isset($p->amati_tangan) && $p->amati_tangan == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="luas_pandang" value="1" class="form-check-input fs-4" <?php echo e((isset($p->luas_pandang) && $p->luas_pandang == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="luas_pandang" value="0" class="form-check-input fs-4" <?php echo e((isset($p->luas_pandang) && $p->luas_pandang == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="arah_mata" value="1" class="form-check-input fs-4" <?php echo e((isset($p->arah_mata) && $p->arah_mata == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="arah_mata" value="0" class="form-check-input fs-4" <?php echo e((isset($p->arah_mata) && $p->arah_mata == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="suara_gembira" value="1" class="form-check-input fs-4" <?php echo e((isset($p->suara_gembira) && $p->suara_gembira == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="suara_gembira" value="0" class="form-check-input fs-4" <?php echo e((isset($p->suara_gembira) && $p->suara_gembira == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="radio" name="senyum_mainan" value="1" class="form-check-input fs-4" <?php echo e((isset($p->senyum_mainan) && $p->senyum_mainan == 1) ? 'checked' : ''); ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="radio" name="senyum_mainan" value="0" class="form-check-input fs-4" <?php echo e((isset($p->senyum_mainan) && $p->senyum_mainan == 0) ? 'checked' : ''); ?>>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
...
<?php echo $__env->make('pengguna.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MomSpire\resources\views\pengguna\kia-bulanan-bayi.blade.php ENDPATH**/ ?>