<?php $__env->startSection('title', 'Buku KIA ' . ($pengguna->name ?? 'Pengguna') . ' - MomSpire'); ?>
<?php $__env->startSection('header_title', 'Kelola Buku KIA'); ?>
<?php $__env->startSection('header_subtitle', 'Kelola catatan dan template Buku KIA untuk pengguna.'); ?>
<?php $__env->startSection('header_action'); ?>
	<a href="<?php echo e(route('bidan.pengguna')); ?>" class="btn btn-back-page">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-start gap-3">
            <div>
                <div class="bp-user-badge">
                    ...
                    <?php echo e($pengguna->name ?? 'Pengguna'); ?>

                </div>
                <h1 class="bp-heading">Buku KIA</h1>
                <p class="bp-subheading mb-0">Kelola catatan Buku KIA untuk <?php echo e($pengguna->name); ?>.</p>
            </div>
        </div>
    </div>
        ...
        <div class="bp-card-body">
            ...
            <div class="bp-tabs">
                <button type="button" class="bp-tab-btn active" onclick="showTab('buku-kia')">
                    ...
                    Buku KIA
                    <span class="badge bg-danger rounded-pill ms-1"><?php echo e($entries->count()); ?></span>
                </button>
            ...
            <div id="tab-buku-kia" class="bp-tab-content active">
                    ...
                    <?php $__currentLoopData = $entries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bp-entry-item">
                            <div class="bp-entry-header">
                                <div>
                                    <h5 class="bp-entry-title"><?php echo e($entry->judul ?? 'Tanpa Judul'); ?></h5>
                                    <div class="bp-entry-meta">
                                        <i class="bi bi-calendar3 me-1"></i><?php echo e($entry->created_at->format('d M Y, H:i')); ?>

                                    </div>
                                </div>
                            </div>
                            <?php if($entry->catatan): ?>
                                <p class="bp-entry-catatan"><?php echo e(Str::limit($entry->catatan, 200)); ?></p>
                            <?php endif; ?>
                            <div class="bp-entry-actions">
                                <a href="<?php echo e($entry->file_path ? asset('storage/' . $entry->file_path) : '#'); ?>"
                                   class="btn btn-bp-primary btn-sm"
                                   target="_blank"
                                   <?php echo e(!$entry->file_path ? 'onclick="return false;" style="opacity:0.5;cursor:not-allowed;"' : ''); ?>>
                                    <i class="bi bi-eye-fill me-1"></i>Lihat
                                </a>
                                <form action="<?php echo e(route('bidan.pengguna.bukuKIA.destroy', $entry->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Yakin hapus catatan ini?')">
                                    <?php echo csrf_field(); ?>
                ...
                <?php else: ?>
                    <div class="bp-empty">
                        ...
                        <p class="bp-empty-text">Tambahkan catatan Buku KIA untuk <?php echo e($pengguna->name); ?> menggunakan tab "Tambah Buku KIA".</p>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div id="tab-tambah-buku" class="bp-tab-content">
                    ...
                    <div class="bp-template-grid">
                        <?php $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bp-template-card"
                                 ...
                                 data-template-name="<?php echo e($template->nama); ?>"
                                 onclick="selectBukuTemplate(this)">
                                <div class="bp-template-icon">
                                    <i class="bi bi-file-earmark-pdf-fill"></i>
                                </div>
                                <div class="bp-template-name"><?php echo e($template->nama ?? 'Template'); ?></div>
                                <?php if($template->deskripsi): ?>
                                    <div class="bp-template-desc"><?php echo e(Str::limit($template->deskripsi, 50)); ?></div>
                                <?php endif; ?>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                ...
                <div class="bp-form-card">
                    ...
                    <form method="POST" action="<?php echo e(route('bidan.pengguna.bukuKIA.store', $pengguna->id)); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="judul" placeholder="Contoh: Buku KIA (Nama Anak)" required>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('bidan.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MomSpire\resources\views\bidan\bukuKIAPengguna.blade.php ENDPATH**/ ?>