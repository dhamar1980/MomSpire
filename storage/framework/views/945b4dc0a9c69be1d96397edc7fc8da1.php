<?php $__env->startSection('title', 'Jadwal Dokter - MomSpire'); ?>
    ...
    <div class="section-card p-4 p-lg-5 mb-4">
        <div class="row align-items-center g-3">
            ...
            <div class="col-lg-4 text-lg-end">
                <form method="GET" action="<?php echo e(route('dokter.jadwal')); ?>" class="d-flex gap-2">
    ...
    <div class="row g-4">
        <div class="col-lg-5">
            <div class="section-card p-4 h-100">
                ...
                <form method="POST" action="<?php echo e(route('dokter.jadwal.store')); ?>" id="jadwalForm">
                    <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('dokter.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MomSpire\resources\views\dokter\jadwal.blade.php ENDPATH**/ ?>