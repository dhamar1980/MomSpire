<?php $__env->startSection('title', 'Pengaturan Bidan - MomSpire'); ?>
<?php $__env->startSection('header_title', 'Pengaturan'); ?>
<?php $__env->startSection('header_subtitle', 'Kelola profil akun bidan, email, dan keamanan password.'); ?>
    ...
    <div class="row g-4 mb-4 align-items-start">
        <div class="col-lg-4">
            <div class="ps-3">
                ...
                <p class="text-muted small">Perbarui informasi profil dan alamat email akun bidan.</p>
            </div>
        </div>
        ...
        <div class="col-lg-8">
            <div class="admin-card settings-section h-100">
                <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <h5 class="mb-0"><i class="bi bi-person-circle me-2"></i>Profil Bidan</h5>
                    <span class="text-muted small">Kelola identitas akun yang dipakai login bidan.</span>
                </div>
                <div class="card-body">
                    <form id="bidanProfileForm" action="<?php echo e(route('bidan.settings.profile')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label class="form-label">Nama Lengkap</label>
                                <input type="text" class="form-control" id="bidanProfileNama" name="name" value="<?php echo e(old('name', $bidanUser->name)); ?>" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Email</label>
                                <input type="email" class="form-control" id="bidanProfileEmail" name="email" value="<?php echo e(old('email', $bidanUser->email)); ?>" required>
                            </div>
                            <div class="col-12">
                                <label class="form-label">No. Telepon</label>
                                <input type="tel" class="form-control" id="bidanProfileTelp" name="no_telp" value="<?php echo e(old('no_telp', $bidanUser->no_telp ?? '')); ?>" placeholder="08xxxxxxxxxx">
                            </div>
                        </div>
                        <div class="mt-4">
    ...
    <div class="row g-4 mb-4 align-items-start">
        ...
        <div class="col-lg-8">
            <div class="admin-card settings-section h-100">
                ...
                <div class="card-body">
                    <form id="bidanPasswordForm" action="<?php echo e(route('bidan.settings.password')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
                            <label class="form-label">Password Saat Ini</label>
                            <input type="password" class="form-control" id="bidanCurrentPassword" name="current_password" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Password Baru</label>
                            <input type="password" class="form-control" id="bidanNewPassword" name="new_password" minlength="8" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Konfirmasi Password Baru</label>
                            <input type="password" class="form-control" id="bidanConfirmPassword" name="new_password_confirmation" minlength="8" required>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div id="twoFactorDisabledState" class="<?php echo e($twoFactorEnabled ? 'd-none' : ''); ?>">
                        <div class="alert alert-light border mb-3">
                            Fitur ini akan meminta password bidan sebelum aktif, lalu menampilkan QR code untuk dipindai.
                        </div>
        ...
        <div class="col-lg-8">
            <div class="admin-card settings-section session-card h-100">
                <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                    ...
                    <span class="text-muted small">Lihat perangkat yang sedang login ke akun bidan.</span>
                </div>
                <div class="card-body">
                    ...
                    <?php if(count($browserSessions) > 0): ?>
                        ...
                        <div class="d-flex flex-wrap gap-2 mt-3">
                            ...
                            <span class="text-muted small align-self-center">Butuh password bidan untuk konfirmasi.</span>
                        </div>
                    <?php else: ?>
            ...
            <div class="modal-content">
                ...
                <form id="securityConfirmForm">
                    <div class="modal-body">
                        <p class="text-muted mb-3" id="securityConfirmModalText">Masukkan password bidan untuk melanjutkan.</p>
                        <div class="mb-3">
...
<script>
    window.MOMSPIRE_BIDAN_SETTINGS = {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const settings = window.MOMSPIRE_BIDAN_SETTINGS || {};
        ...
        function openPasswordModal(options) {
            ...
            if (confirmText) confirmText.textContent = options.text || 'Masukkan password bidan untuk melanjutkan.';
        ...
        if (enableTwoFactorBtn) {
            enableTwoFactorBtn.addEventListener('click', function() {
                requirePasswordConfirmation({
                    title: 'Aktifkan 2FA',
                    text: 'Masukkan password bidan untuk mengaktifkan autentikasi dua faktor.',
        ...
        if (disableTwoFactorBtn) {
            disableTwoFactorBtn.addEventListener('click', function() {
                requirePasswordConfirmation({
                    ...
                    text: 'Masukkan password bidan untuk menonaktifkan autentikasi dua faktor.',
        ...
        if (showTwoFactorQrBtn) {
            showTwoFactorQrBtn.addEventListener('click', function() {
                requirePasswordConfirmation({
                    ...
                    text: 'Masukkan password bidan untuk melihat QR code 2FA.',
        ...
        if (showRecoveryCodesBtn) {
            showRecoveryCodesBtn.addEventListener('click', function() {
                requirePasswordConfirmation({
                    ...
                    text: 'Masukkan password bidan untuk melihat recovery codes.',
        ...
        if (regenerateRecoveryCodesBtn) {
            regenerateRecoveryCodesBtn.addEventListener('click', function() {
                requirePasswordConfirmation({
                    ...
                    text: 'Masukkan password bidan untuk membuat recovery codes baru.',
        ...
        if (logoutOtherSessionsBtn) {
            logoutOtherSessionsBtn.addEventListener('click', function() {
                requirePasswordConfirmation({
                    ...
                    text: 'Masukkan password bidan untuk mengeluarkan sesi di perangkat lain.',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('bidan.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MomSpire\resources\views/bidan/pengaturan.blade.php ENDPATH**/ ?>