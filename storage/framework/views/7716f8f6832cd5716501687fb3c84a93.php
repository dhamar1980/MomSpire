        ...
        <div class="col-12">
            <div style="border: 1px solid rgba(15, 23, 42, 0.08); border-radius: 18px; background: #fff; box-shadow: 0 10px 30px rgba(15, 23, 42, 0.04); padding: 2rem;">
                ...
                <?php if($templates->count() > 0): ?>
                    ...
                    <form id="tambahBukuForm" method="POST" action="<?php echo e(route('dokter.bukuKIA.store')); ?>" class="d-none">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="buku-list-item p-3 border-bottom">
                                <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        <form action="<?php echo e(route('dokter.bukuKIA.delete', $buku->id)); ?>" method="POST" style="display: inline;" onsubmit="return confirm('Yakin hapus?')">
                                            <?php echo csrf_field(); ?>
...
<script>
    ...
    function editBuku(id, judul, catatan) {
        document.getElementById('editBukuForm').action = '<?php echo e(route("dokter.bukuKIA.update", ":id")); ?>'.replace(':id', id);
...
<?php echo $__env->make('dokter.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MomSpire\resources\views\dokter\bukuKIA.blade.php ENDPATH**/ ?>