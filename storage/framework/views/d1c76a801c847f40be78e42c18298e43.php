<?php $__env->startSection('title', 'Keluarga Berencana - MomSpire'); ?>
<?php $__env->startSection('header_title', 'Keluarga Berencana'); ?>
<?php $__env->startSection('header_subtitle', 'Rencanakan kehamilan yang sehat melalui program Keluarga Berencana (KB).'); ?>
...
<div class="row g-4 animate__animated animate__fadeIn">
    ...
    <div class="col-12">
        ...
        <form action="<?php echo e(route('pengguna.kb.save')); ?>" method="POST">
            <?php echo csrf_field(); ?>
                                ...
                                <div class="d-flex align-items-start gap-3">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="form-group pt-3 border-top">
                                            ...
                                            <input type="text" name="paraf_ibu" id="paraf_ibu" value="<?php echo e($kb->paraf_ibu ?? ''); ?>" class="form-control rounded-pill px-4" placeholder="Ketik nama lengkap atau inisial Ibu sebagai paraf...">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('pengguna.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MomSpire\resources\views\pengguna\kia-kb.blade.php ENDPATH**/ ?>